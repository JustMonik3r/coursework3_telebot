package com.coursework3.telebot.listener;
...
import com.coursework3.telebot.repository.NotificationTaskRepository;
    ...
    public int process(List<Update> updates) {
        updates.forEach(update -> {
            ...
            if (update.message().text().equals("/start")) {
                SendMessage message = new SendMessage(chatId, String.format("Привет, %s! Введи сообщение в формате ДД.ММ.ГГГГ 00:00 Текст сообщения", update.message().from().firstName()));
